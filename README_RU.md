...
### Системные требования и выбор Vision-модели

Для работы программы требуется видеокарта от NVIDIA (для ускорения CUDA) или Apple Silicon (процессоры M-серии). Ниже приведена таблица совместимости железа и рекомендуемых моделей в LM Studio:

| **Класс системы / Видеокарта**                                                                                                                                                                                    | **Рекомендуемая Vision-модель в LM Studio**                                                                      | **Требования к железу и параметры запуска**                                                                                                                                                                                                                                                |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Бюджетный уровень**<br><br>  <br><br>• GTX 1060 / 1660<br><br>  <br><br>• RTX 3050 / 4050<br><br>  <br><br>• Карты с **6 ГБ VRAM**                                                                              | **moondream2**<br><br>  <br><br>_(или Qwen2-VL-2B-Instruct в Q4/Q5)_                                             | • **VRAM:** ~4–6 ГБ<br><br>  <br><br>• **ОЗУ:** 8–16 ГБ<br><br>  <br><br>• **Параметры:** Квантование `Q4_K_M` или `Q5_K_M`. Быстрый инференс на слабых картах и ноутбуках, базовое распознавание объектов.                                                                                |
| **Оптимальный (Рекомендуемый)**<br><br>  <br><br>• RTX 3060 (12GB)<br><br>  <br><br>• RTX 4060 Ti (16GB)<br><br>  <br><br>• RTX 4070 / 4070 Super (12GB)<br><br>  <br><br>• Apple M1/M2/M3 (16GB+ Unified Memory) | **Llama-3.2-11B-Vision-Instruct-GGUF**<br><br>  <br><br>_(альтернатива: Qwen2-VL-7B-Instruct-GGUF)_              | • **VRAM:** 8–12 ГБ под модель<br><br>  <br><br>• **ОЗУ:** 16–32 ГБ<br><br>  <br><br>• **Параметры:** Квантование `Q4_K_M` / `Q5_K_M`. Полный перенос слоев в видеопамять (`GPU Offload = Max`). Отличный баланс скорости и глубины описания (поддерживает сложные детали, текст на фото). |
| **Энтузиаст / Профи**<br><br>  <br><br>• RTX 3090 / 4090 (24GB)<br><br>  <br><br>• RTX 4080 (16GB)<br><br>  <br><br>• Apple Mac Studio (32GB+ Unified Memory)                                                     | **Llama-3.2-11B-Vision-Instruct** в Q8_0 / FP16<br><br>  <br><br>_(или тяжелые модели вроде InternVL2-26B в Q4)_ | • **VRAM:** 16–24+ ГБ<br><br>  <br><br>• **ОЗУ:** 32–64 ГБ<br><br>  <br><br>• **Параметры:** Квантование `Q8_0` или оригинальный формат без потери качества. Максимальный контекст, мгновенная обработка пакетов изображений, безошибочный анализ мелких деталей.                          |
